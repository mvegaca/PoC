...
namespace Issue1356.Repro.ViewModels
{
    public class ShellViewModel : Screen
    {
        ...
        private void PopulateNavItems()
        {
            ...
            PrimaryItems.Add(new ShellNavigationItem("Shell_Main".GetLocalized(), Symbol.Document, typeof(MainViewModel)));
            PrimaryItems.Add(new ShellNavigationItem("Shell_Companies".GetLocalized(), Symbol.Document, typeof(CompaniesViewModel)));
        }

        public void ItemSelected(ItemClickEventArgs args)
        {
