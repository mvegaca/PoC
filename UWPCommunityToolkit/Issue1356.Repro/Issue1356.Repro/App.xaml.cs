...
namespace Issue1356.Repro
{
    public sealed partial class App
    {
        ...
        protected override void Configure()
        {
            ...
            _container.PerRequest<CompaniesViewModel>();
        }
        ...
        {
            return new ActivationService(_container, typeof(ViewModels.MainViewModel), new Views.ShellPage());
        }
    }
}
