...
using OldImageGalleryApp.Helpers;
using OldImageGalleryApp.Models;
using OldImageGalleryApp.Services;
using OldImageGalleryApp.Views;

using Windows.Storage;
using Windows.UI.Xaml.Controls;
using Windows.UI.Xaml.Media.Animation;

namespace OldImageGalleryApp.ViewModels
{
