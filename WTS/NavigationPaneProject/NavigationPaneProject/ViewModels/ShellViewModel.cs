...
using NavigationPaneProject.Views;
...
namespace NavigationPaneProject.ViewModels
{
    public class ShellViewModel : Observable
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<GridPage>("Shell_Grid".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<MediaPlayerPage>("Shell_MediaPlayer".GetLocalized(), Symbol.Document));
