...
{
    public sealed partial class MediaPlayerWithMarginsPage : Page
    {
        public MediaPlayerWithMarginsViewModel ViewModel { get; } = new MediaPlayerWithMarginsViewModel();
        ...
        public MediaPlayerWithMarginsPage()
        {
            InitializeComponent();
        }
